...
export type RealtimeEvent =
  ...
  // Jam lifecycle — channel-scoped fanout like message events. Every
  // member of the channel hears these. user_id is the actor (joiner /
  // leaver); started_by lives in the payload for `jam.started`.
  | {
      type: 'jam.started'
      workspace_id: string
      channel_id: string
      payload: { jam_id: string; started_by: string; started_at: string }
      emitted_at: string
    }
  | {
      type: 'jam.ended'
      workspace_id: string
      channel_id: string
      payload: { jam_id: string; ended_at: string; duration_seconds: number }
      emitted_at: string
    }
  | {
      ...
      channel_id: string
      user_id: string
      payload: { jam_id: string; joined_at: string }
      emitted_at: string
    }
  | {
      ...
      channel_id: string
      user_id: string
      payload: { jam_id: string; left_at: string }
      emitted_at: string
    }
  ...
  // jam.recording_started across every connected client in the channel.
  | {
      type: 'jam.recording_started'
      workspace_id: string
      channel_id: string
      payload: { recording_id: string; jam_id: string; started_by: string; started_at: string }
      emitted_at: string
    }
  | {
      ...
      workspace_id: string
      channel_id: string
      payload: { recording_id: string; jam_id: string; stopped_at: string }
      emitted_at: string
    }
  | {
      ...
      workspace_id: string
      channel_id: string
      payload: { recording_id: string; jam_id: string; transcript_message_id: string }
      emitted_at: string
    }
  | {
