...
export declare function configure(next: Partial<ClientConfig>): void;
...
export type InviteWithToken = Invite & {
    token: string;
};
...
export type OperatorAPIKeyWithPlaintext = OperatorAPIKey & {
    plaintext: string;
};
